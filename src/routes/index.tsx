      ...
      <section className="grid gap-6 lg:grid-cols-[1.4fr_1fr] items-stretch">
        <div className="brutal-card bg-primary p-6 sm:p-10 animate-pop-in">
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            ...
            <Link to="/cvv.docx" className="brutal-border bg-card px-5 py-3 font-black uppercase brutal-shadow-sm hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-[6px_6px_0_0_var(--color-ink)] transition-all">
              RESUME
            </Link>
          </div>
        </div>
